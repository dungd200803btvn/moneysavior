...
public class CategorizeTransactionPrompt extends Prompt {
    public CategorizeTransactionPrompt(String message, List<String> categories) {
        super("""
                ...
                description: string (tóm tắt mục đích chi nếu là chi tiêu, hoặc nguồn thu nếu là thu nhập, nhớ không bao gồm số tiền)
                amount: number (số tiền)
                Chú ý trong nội dung message thường sẽ có mục đích tiêu tiền / nguồn nhận tiền, số tiền và đơn vị có thể là k (10^3), lít/loét (10^5), tr/củ (10^6), tỉ/tỏi (10^9), hoặc các đơn vị trong tiếng Việt tương tự. Hãy trả về đúng format json vì nếu không ứng dụng của tôi sẽ bị lỗi.
                """
